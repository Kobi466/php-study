<?php
require "bai2/PHPMailer-master/src/PHPMailer.php";  //nhúng thư viện vào để dùng, sửa lại đường dẫn cho đúng nếu bạn lưu vào chỗ khác
require "bai2/PHPMailer-master/src/SMTP.php"; //nhúng thư viện vào để dùng
require 'bai2/PHPMailer-master/src/Exception.php'; //nhúng thư viện vào để dùng
